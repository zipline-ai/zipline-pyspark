...
class DatabricksStagingQuery:
    """Executes a Chronon StagingQuery on Databricks by delegating to the Scala batch driver.

    Mirrors JupyterStagingQuery with additional Databricks notebook integrations:
    ...
    def run(
        ...
        """Compile the config, run the Scala staging-query-backfill driver, and return the result.
